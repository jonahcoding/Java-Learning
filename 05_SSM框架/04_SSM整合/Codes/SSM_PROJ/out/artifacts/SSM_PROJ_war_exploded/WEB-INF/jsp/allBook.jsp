        ...
        <div class="row">
            ...
            <div class="col-md-4 column" style="float: right">
                ...
                <form action="${pageContext.request.contextPath}/book/queryBook" method="get">
                    ...
                    <input type="text" name="queryBookName" class="form-inline" placeholder="请输入要查询的书籍名称" required>
